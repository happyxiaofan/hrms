          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">教育培训人员基本信息列表</span></td>
              </tr>
            </table></td>
        ...
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6">
			...
			<tr>
				...
				<td height="20" bgcolor="#FFFFFF">
					<div align="center">
						<span class="STYLE19">
							<a href="${pageContext.request.contextPath}/deleteTreServlet?treId=<%=tre.getTreId() %>">删除 </a>| 
							<a href="${pageContext.request.contextPath}/listEduServlet?item=update&treId=<%=tre.getTreId() %>">修改</a>
						</span>
					</div>
				</td>
			</tr>
    ...
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td width="49"><div align="center"><img src="../res/images/main_54.gif" width="40" height="15" /></div></td>
            <td width="49"><div align="center"><img src="../res/images/main_55.gif" width="45" height="15" /></div></td>
            <td width="49"><div align="center"><img src="../res/images/main_58.gif" width="45" height="15" /></div></td>
            <td width="49"><div align="center"><img src="../res/images/main_60.gif" width="40" height="15" /></div></td>
            <td width="37" class="STYLE22"><div align="center">转到</div></td>
            <td width="22"><div align="center">
              <input type="text" name="textfield" id="textfield"  style="width:20px; height:12px; font-size:12px; border:solid 1px #7aaebd;"/>
            </div></td>
            <td width="22" class="STYLE22"><div align="center">页</div></td>
            <td width="35"><img src="../res/images/main_62.gif" width="26" height="15" /></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
