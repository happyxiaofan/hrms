...
font-size:18px;}
  ...
  <body>
    <form action="${pageContext.request.contextPath}/addpChange" method="post">
		<table>
			<tr>
				<td>人事调动编号：</td>
			...
			<tr>
    			...
    			<img onclick="WdatePicker({el:'pChange_time'})" src="res/js/DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
			</tr>
			<tr>
				<td>变动前状态： </td>
